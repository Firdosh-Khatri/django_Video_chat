...
btnJoin.addEventListener('click',() => {
 ...
 const btnToggleAudio = document.querySelector('#btn-toogle-audio');
 const btnToggleVideo = document.querySelector('#btn-toogle-video');
...
function createOfferer(peerUsername, receiver_channel_name){
        ...
        peer.addEventListener('iceconnectionstatechange',() => {
            ...
            console.log('ICE Connection State: ', iceConnectionState); // Debug log
...
function createVideo(peerUsername){
        ...
        remoteVideo.id = peerUsername + '_video';
